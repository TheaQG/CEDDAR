#!/bin/bash
#SBATCH --job-name=B0_EMA
#SBATCH --output=logs/slurm_B0_EMA_%x_%j.log
#SBATCH --error=logs/slurm_B0_EMA_%x_%j.err
...
# ===================================================================
# B0_EMA: BASELINE MODEL WITH EMA ENABLED FOR ABLATION STUDIES
# ===================================================================
...
CFG="$CONFIG_DIR/B0_EMA.yaml"

echo "[INFO] Running ablation basic + EMA: training → generation → quicklook → evaluation (inside container)"
