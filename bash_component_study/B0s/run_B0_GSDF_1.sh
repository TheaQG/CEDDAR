#!/bin/bash
#SBATCH --job-name=B0_GSDF_1
#SBATCH --output=logs/slurm_B0_GSDF_1_%x_%j.log
#SBATCH --error=logs/slurm_B0_GSDF_1_%x_%j.err
...
# ========================================================================
# B0_GSDF_1: BASELINE MODEL WITH GEOGRAPHIC CONDITIONS AND SDF WEIGHTED LOSS - REPLICATE WITH SEED 1011
# ========================================================================
...
CFG="$CONFIG_DIR/B0_GSDF_1.yaml"

echo "[INFO] REPLICATE: Running ablation basic: training → generation → quicklook → evaluation (inside container)"
