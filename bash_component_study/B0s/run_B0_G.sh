#!/bin/bash
#SBATCH --job-name=B0_G
#SBATCH --output=logs/slurm_B0_G_%x_%j.log
#SBATCH --error=logs/slurm_B0_G_%x_%j.err
...
# ===================================================================
# B0 + G: BASELINE MODEL + GEOGRAPHIC CONDITIONS (TOPO + LSM)
# ===================================================================
