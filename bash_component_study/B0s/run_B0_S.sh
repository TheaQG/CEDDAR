#!/bin/bash
#SBATCH --job-name=B0_S
#SBATCH --output=logs/slurm_B0_S_%x_%j.log
#SBATCH --error=logs/slurm_B0_S_%x_%j.err
...
# ===================================================================
# B0_S: BASELINE MODEL WITH SEASONAL INFORMATION CONFIGURATION FOR ABLATION STUDIES 
# ===================================================================
...
CFG="$CONFIG_DIR/B0_S.yaml"

echo "[INFO] Running ablation B0 + S: training → generation → quicklook → evaluation (inside container)"
