#!/bin/bash
#SBATCH --job-name=B0_G_1
#SBATCH --output=logs/slurm_B0_G_1_%x_%j.log
#SBATCH --error=logs/slurm_B0_G_1_%x_%j.err
...
# ===================================================================
# B0_G_1: BASELINE MODEL + GEOGRAPHIC CONDITIONS (TOPO + LSM) REPLICATE WITH SEED 1011
# ===================================================================
