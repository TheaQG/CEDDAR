#!/bin/bash
#SBATCH --job-name=B0_0
#SBATCH --output=logs/slurm_B0_0_%x_%j.log
#SBATCH --error=logs/slurm_B0_0_%x_%j.err
...
# ===================================================================
# B0_0: BASELINE MODEL CONFIGURATION FOR ABLATION STUDIES (duplicate, same seed=504)
# ===================================================================
...
CFG="$CONFIG_DIR/B0_0.yaml"

echo "[INFO] Running ablation basic (duplicate, same seed=504): training → generation → quicklook → evaluation (inside container)"
