#!/bin/bash
#SBATCH --job-name=B0_S_EMA_1
#SBATCH --output=logs/slurm_B0_S_EMA_1_%x_%j.log
#SBATCH --error=logs/slurm_B0_S_EMA_1_%x_%j.err
...
# ===================================================================
# B0_S_EMA_1: BASELINE MODEL WITH SEASONAL INFORMATION AND EMA CONFIGURATION FOR ABLATION STUDIES - REPLICATE WITH SEED 1011
# ===================================================================
...
CONFIG_DIR="$ROOT_DIR/sbgm/config/component_study/B0s"
...
CFG="$CONFIG_DIR/B0_S_EMA_1.yaml"

echo "[INFO] Running ablation B0 + S + EMA (replicate with seed 1011): training → generation → quicklook → evaluation (inside container)"
