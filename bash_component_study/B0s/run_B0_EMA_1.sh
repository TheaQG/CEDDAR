#!/bin/bash
#SBATCH --job-name=B0_EMA_1
#SBATCH --output=logs/slurm_B0_EMA_1_%x_%j.log
#SBATCH --error=logs/slurm_B0_EMA_1_%x_%j.err
...
# ===================================================================
# B0_EMA_1: BASELINE MODEL WITH EMA ENABLED FOR ABLATION STUDIES (REPLICATE WITH SEED 1011)
# ===================================================================
...
CFG="$CONFIG_DIR/B0_EMA_1.yaml"

echo "[INFO] Running ablation basic + EMA (replicate with seed 1011): training → generation → quicklook → evaluation (inside container)"
