#!/bin/bash
#SBATCH --job-name=B0_GSDF
#SBATCH --output=logs/slurm_B0_GSDF_%x_%j.log
#SBATCH --error=logs/slurm_B0_GSDF_%x_%j.err
...
# ========================================================================
# B0_GSDF: BASELINE MODEL WITH GEOGRAPHIC CONDITIONS AND SDF WEIGHTED LOSS 
# ========================================================================
