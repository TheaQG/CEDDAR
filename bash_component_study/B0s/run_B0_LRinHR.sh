#!/bin/bash
#SBATCH --job-name=B0_LRinHR
#SBATCH --output=logs/slurm_B0_LRinHR_%x_%j.log
#SBATCH --error=logs/slurm_B0_LRinHR_%x_%j.err
...
# =========================================================================
# B0_LRinHR: BASELINE MODEL BUT WITH LR CONDITION SCALED WITH HR STATISTICS
# =========================================================================
