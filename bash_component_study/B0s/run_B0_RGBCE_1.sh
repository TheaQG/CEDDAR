#!/bin/bash
#SBATCH --job-name=B0_RGBCE_1
#SBATCH --output=logs/slurm_B0_RGBCE_1_%x_%j.log
#SBATCH --error=logs/slurm_B0_RGBCE_1_%x_%j.err
...
# ===================================================================
# B0_RGBCE_1: BASELINE MODEL + RAIN-GATING AUXILIARY LOSS - REPLICATE WITH SEED 1011
# ===================================================================
...
CFG="$CONFIG_DIR/B0_RGBCE_1.yaml"

echo "[INFO] REPLICATE: Running ablation + RGBCE: training → generation → quicklook → evaluation (inside container)"
