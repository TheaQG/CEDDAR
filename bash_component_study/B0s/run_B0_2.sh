#!/bin/bash
#SBATCH --job-name=B0_2
#SBATCH --output=logs/slurm_B0_2_%x_%j.log
#SBATCH --error=logs/slurm_B0_2_%x_%j.err
...
# ===================================================================
# B0_2: BASELINE MODEL CONFIGURATION FOR ABLATION STUDIES (SECOND REPLICATE FOR SEED NOISE, SEED 607)
# ===================================================================
...
CFG="$CONFIG_DIR/B0_2.yaml"

echo "[INFO] REPLICATE 2: Running ablation basic (2nd replicate, seed 607): training → generation → quicklook → evaluation (inside container)"
