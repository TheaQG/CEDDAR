#!/bin/bash
#SBATCH --job-name=B0_1
#SBATCH --output=logs/slurm_B0_1_%x_%j.log
#SBATCH --error=logs/slurm_B0_1_%x_%j.err
...
# ===================================================================
# B0_1: BASELINE MODEL CONFIGURATION FOR ABLATION STUDIES (FIRST REPLICATE FOR SEED NOISE, SEED 1011)
# ===================================================================
...
CFG="$CONFIG_DIR/B0_1.yaml"

echo "[INFO] REPLICATE 1: Running ablation basic (1st replicate, seed 1011): training → generation → quicklook → evaluation (inside container)"
