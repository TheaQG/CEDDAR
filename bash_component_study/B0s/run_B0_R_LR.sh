#!/bin/bash
#SBATCH --job-name=B0_R_LR
#SBATCH --output=logs/slurm_B0_R_LR_%x_%j.log
#SBATCH --error=logs/slurm_B0_R_LR_%x_%j.err
...
# ==============================================================================================================
# B0_R_LR: BASELINE MODEL + RESIDUAL PREDICTION FROM LR BASELINE SCALED IN LR SPACE + LR CONDITION SCALED IN LR SPACE
# ==============================================================================================================
