#!/bin/bash
#SBATCH --job-name=B0_D
#SBATCH --output=logs/slurm_B0_D_%x_%j.log
#SBATCH --error=logs/slurm_B0_D_%x_%j.err
...
# ===================================================================
# B0_D: BASELINE MODEL + DUAL LR CHANNELS FOR ABLATION STUDIES
# ===================================================================
