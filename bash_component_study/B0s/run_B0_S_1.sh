...
CFG="$CONFIG_DIR/B0_S_1.yaml"

echo "[INFO] REPLICATE 1: Running ablation B0 + S (1st replicate, seed 1011): training → generation → quicklook → evaluation (inside container)"
