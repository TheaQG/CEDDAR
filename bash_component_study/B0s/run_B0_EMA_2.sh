#!/bin/bash
#SBATCH --job-name=B0_EMA_2
#SBATCH --output=logs/slurm_B0_EMA_2_%x_%j.log
#SBATCH --error=logs/slurm_B0_EMA_2_%x_%j.err
...
# ===================================================================
# B0_EMA_2: BASELINE MODEL WITH EMA ENABLED FOR ABLATION STUDIES (REPLICATE WITH SEED 607)
# ===================================================================
...
CFG="$CONFIG_DIR/B0_EMA_2.yaml"

echo "[INFO] Running ablation basic + EMA (replicate with seed 607): training → generation → quicklook → evaluation (inside container)"
