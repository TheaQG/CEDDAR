#!/bin/bash
#SBATCH --job-name=B0_RGBCE
#SBATCH --output=logs/slurm_B0_RGBCE_%x_%j.log
#SBATCH --error=logs/slurm_B0_RGBCE_%x_%j.err
...
# ===================================================================
# B0_RGBCE: BASELINE MODEL + RAIN-GATING AUXILIARY LOSS
# ===================================================================
...
CFG="$CONFIG_DIR/B0_RGBCE.yaml"

echo "[INFO] Running ablation + RGBCE: training → generation → quicklook → evaluation (inside container)"
