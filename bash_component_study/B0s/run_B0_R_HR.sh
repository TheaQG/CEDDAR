#!/bin/bash
#SBATCH --job-name=B0_R_HR
#SBATCH --output=logs/slurm_B0_R_HR_%x_%j.log
#SBATCH --error=logs/slurm_B0_R_HR_%x_%j.err
...
# ==============================================================================================================
# B0_R_HR: BASELINE MODEL + RESIDUAL PREDICTION FROM LR BASELINE SCALED IN HR SPACE + LR CONDITION SCALED IN HR SPACE
# ==============================================================================================================
