#!/bin/bash
#SBATCH --job-name=B1_G
#SBATCH --output=logs/slurm_B1_G_%x_%j.log
#SBATCH --error=logs/slurm_B1_G_%x_%j.err
...
# ===================================================================
# B1_G: BASELINE B1 + GEOGRAPHIC CONDITIONS
# ===================================================================
...
CFG="$CONFIG_DIR/B1_G.yaml"

echo "[INFO] Running ablation B1 + geographic conditions: training → generation → quicklook → evaluation (inside container)"
