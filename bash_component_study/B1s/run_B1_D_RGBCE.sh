#!/bin/bash
#SBATCH --job-name=B1_D_RGBCE
#SBATCH --output=logs/slurm_B1_D_RGBCE_%x_%j.log
#SBATCH --error=logs/slurm_B1_D_RGBCE_%x_%j.err
...
# ===================================================================
# B1_D_RGBCE: BASELINE B1 + dual LR channels + RAINGATE BCE (WITHOUT REWEIGHTING)
# ===================================================================
...
CFG="$CONFIG_DIR/B1_D_RGBCE.yaml"

echo "[INFO] Running ablation B1 + dual LR channels + RainGate BCE without reweighting: training → generation → quicklook → evaluation (inside container)"
