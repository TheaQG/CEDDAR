#!/bin/bash
#SBATCH --job-name=B1_GSDF
#SBATCH --output=logs/slurm_B1_GSDF_%x_%j.log
#SBATCH --error=logs/slurm_B1_GSDF_%x_%j.err
...
# ===================================================================
# B1_GSDF: BASELINE B1 + GEOGRAPHIC CONDITIONS AND SDF WEIGHTED LOSS
# ===================================================================
...
CFG="$CONFIG_DIR/B1_GSDF.yaml"

echo "[INFO] Running ablation B1 + geographic conditions and SDF weighted loss: training → generation → quicklook → evaluation (inside container)"
