#!/bin/bash
#SBATCH --job-name=B1_GSDF_1
#SBATCH --output=logs/slurm_B1_GSDF_1_%x_%j.log
#SBATCH --error=logs/slurm_B1_GSDF_1_%x_%j.err
...
# ===================================================================
# B1_GSDF_1: BASELINE B1 + GEOGRAPHIC CONDITIONS AND SDF WEIGHTED LOSS - REPLICATE WITH SEED 1011
# ===================================================================
...
CFG="$CONFIG_DIR/B1_GSDF_1.yaml"

echo "[INFO] REPLICATE: Running ablation B1 + geographic conditions and SDF weighted loss: training → generation → quicklook → evaluation (inside container)"
