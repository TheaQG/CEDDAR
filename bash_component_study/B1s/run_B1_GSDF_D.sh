#!/bin/bash
#SBATCH --job-name=B1_GSDF_D
#SBATCH --output=logs/slurm_B1_GSDF_D_%x_%j.log
#SBATCH --error=logs/slurm_B1_GSDF_D_%x_%j.err
...
# ===================================================================
# B1_GSDF_D: BASELINE B1 + GEOGRAPHIC CONDITIONS AND SDF WEIGHTED LOSS + DUAL LR CHANNELS
# ===================================================================
...
CFG="$CONFIG_DIR/B1_GSDF_D.yaml"

echo "[INFO] Running ablation B1 + geographic conditions and SDF weighted loss + dual LR channels: training → generation → quicklook → evaluation (inside container)"
