#!/bin/bash
#SBATCH --job-name=B1_G_1
#SBATCH --output=logs/slurm_B1_G_1_%x_%j.log
#SBATCH --error=logs/slurm_B1_G_1_%x_%j.err
...
# ===================================================================
# B1_G_1: BASELINE B1 + GEOGRAPHIC CONDITIONS - REPLICATE WITH SEED 1011
# ===================================================================
...
CFG="$CONFIG_DIR/B1_G_1.yaml"

echo "[INFO] REPLICATE: Running ablation B1 + geographic conditions: training → generation → quicklook → evaluation (inside container)"
