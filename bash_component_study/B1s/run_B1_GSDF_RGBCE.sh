#!/bin/bash
#SBATCH --job-name=B1_GSDF_RGBCE
#SBATCH --output=logs/slurm_B1_GSDF_RGBCE_%x_%j.log
#SBATCH --error=logs/slurm_B1_GSDF_RGBCE_%x_%j.err
...
# ===================================================================
# B1_GSDF_RGBCE: BASELINE B1 + GEOGRAPHIC CONDITIONS AND SDF-WEIGHTED LOSS + RAINGATE BCE (WITHOUT REWEIGHTING)
# ===================================================================
...
CFG="$CONFIG_DIR/B1_GSDF_RGBCE.yaml"
