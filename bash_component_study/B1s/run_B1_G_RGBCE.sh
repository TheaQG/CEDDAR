#!/bin/bash
#SBATCH --job-name=B1_G_RGBCE
#SBATCH --output=logs/slurm_B1_G_RGBCE_%x_%j.log
#SBATCH --error=logs/slurm_B1_G_RGBCE_%x_%j.err
...
# ===================================================================
# B1_G_RGBCE: BASELINE B1 + geographic conditions + RAINGATE BCE (WITHOUT REWEIGHTING)
# ===================================================================
...
CFG="$CONFIG_DIR/B1_G_RGBCE.yaml"

echo "[INFO] Running ablation B1 + geographic conditions + RainGate BCE without reweighting: training → generation → quicklook → evaluation (inside container)"
