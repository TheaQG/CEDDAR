#!/bin/bash
#SBATCH --job-name=V0_Z_0_noP
#SBATCH --output=logs/slurm_V0_Z_0_noP_%x_%j.log
#SBATCH --error=logs/slurm_V0_Z_0_noP_%x_%j.err
...
# ===================================================================
# V0_Z_0_noP: V0 - precipitation + geopotential height at 500 hPa, small domain context
# ===================================================================
...
CFG="$CONFIG_DIR/single_variables_no_prcp/V_Z_0_noP.yaml"

echo "[INFO] Running V_Z_0_noP: training → generation → quicklook → evaluation (inside container)"
