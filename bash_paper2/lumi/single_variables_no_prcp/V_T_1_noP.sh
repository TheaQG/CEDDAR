#!/bin/bash
#SBATCH --job-name=V0_T_1_noP
#SBATCH --output=logs/slurm_V0_T_1_noP_%x_%j.log
#SBATCH --error=logs/slurm_V0_T_1_noP_%x_%j.err
...
# ===================================================================
# V0_T_1_noP: V0 - precipitation + equivalent potential temperature at 850 hPa, large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/single_variables_no_prcp/V_T_1_noP.yaml"

echo "[INFO] Running V_T_1_noP: training → generation → quicklook → evaluation (inside container)"
