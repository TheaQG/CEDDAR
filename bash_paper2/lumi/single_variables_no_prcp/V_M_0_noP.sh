#!/bin/bash
#SBATCH --job-name=V0_M_0_noP
#SBATCH --output=logs/slurm_V0_M_0_noP_%x_%j.log
#SBATCH --error=logs/slurm_V0_M_0_noP_%x_%j.err
...
# ===================================================================
# V0_M_0_noP: V0 - precipitation + mean sea level pressure, small domain context
# ===================================================================
...
CFG="$CONFIG_DIR/single_variables_no_prcp/V_M_0_noP.yaml"

echo "[INFO] Running V_M_0_noP: training → generation → quicklook → evaluation (inside container)"
