#!/bin/bash
#SBATCH --job-name=P0_multi_GPU_full
#SBATCH --output=logs/slurm_P0_multi_GPU_full_%x_%j.log
#SBATCH --error=logs/slurm_P0_multi_GPU_full_%x_%j.err
...
# ===================================================================
# P0_multi_GPU_full: B1_GSDF_RGBCE (BASELINE B1 + GEOGRAPHIC CONDITIONS AND SDF-WEIGHTED LOSS + RAINGATE BCE (WITHOUT REWEIGHTING) + CONTEXT ENCODER)
# ===================================================================
...
echo "[INFO] Running P0_multi_GPU_full: training → generation → quicklook → evaluation (inside container)"
