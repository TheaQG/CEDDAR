#!/bin/bash
#SBATCH --job-name=P0_test_full
#SBATCH --output=logs/slurm_P0_test_full_%x_%j.log
#SBATCH --error=logs/slurm_P0_test_full_%x_%j.err
...
# ===================================================================
# P0_test_full: B1_GSDF_RGBCE (BASELINE B1 + GEOGRAPHIC CONDITIONS AND SDF-WEIGHTED LOSS + RAINGATE BCE (WITHOUT REWEIGHTING))
# ===================================================================
...
CFG="$CONFIG_DIR/P0_test.yaml"

echo "[INFO] Running P0_test: training → generation → quicklook → evaluation (inside container)"
