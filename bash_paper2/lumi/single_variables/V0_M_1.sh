#!/bin/bash
#SBATCH --job-name=V0_M_1
#SBATCH --output=logs/slurm_V0_M_1_%x_%j.log
#SBATCH --error=logs/slurm_V0_M_1_%x_%j.err
...
# ===================================================================
# V0_M_1: V0 + mean sea level pressure, large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/single_variables/V0_M_1.yaml"

echo "[INFO] Running V0_M_1: training → generation → quicklook → evaluation (inside container)"
