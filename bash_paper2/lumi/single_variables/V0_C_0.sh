#!/bin/bash
#SBATCH --job-name=V0_C_0
#SBATCH --output=logs/slurm_V0_C_0_%x_%j.log
#SBATCH --error=logs/slurm_V0_C_0_%x_%j.err
...
# ===================================================================
# V0_C_0: V0 + CAPE, small domain context
# ===================================================================
...
CFG="$CONFIG_DIR/single_variables/V0_C_0.yaml"

echo "[INFO] Running V0_C_0: training → generation → quicklook → evaluation (inside container)"
