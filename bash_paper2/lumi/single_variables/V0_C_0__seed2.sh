#!/bin/bash
#SBATCH --job-name=V0_C_0__seed2
#SBATCH --output=logs/slurm_V0_C_0__seed2_%x_%j.log
#SBATCH --error=logs/slurm_V0_C_0__seed2_%x_%j.err
...
# ===================================================================
# V0_C_0__seed2: V0 + CAPE, small domain context
# ===================================================================
...
CFG="$CONFIG_DIR/single_variables/V0_C_0__seed2.yaml"

echo "[INFO] Running V0_C_0__seed2: training → generation → quicklook → evaluation (inside container)"
