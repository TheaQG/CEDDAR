#!/bin/bash
#SBATCH --job-name=V0_M_0
#SBATCH --output=logs/slurm_V0_M_0_%x_%j.log
#SBATCH --error=logs/slurm_V0_M_0_%x_%j.err
...
# ===================================================================
# V0_M_0: V0 + mean sea level pressure, small domain context
# ===================================================================
...
CFG="$CONFIG_DIR/single_variables/V0_M_0.yaml"

echo "[INFO] Running V0_M_0: training → generation → quicklook → evaluation (inside container)"
