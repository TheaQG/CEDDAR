#!/bin/bash
#SBATCH --job-name=V0__seed3
#SBATCH --output=logs/slurm_V0__seed3_%x_%j.log
#SBATCH --error=logs/slurm_V0__seed3_%x_%j.err
...
# ===================================================================
# V0__seed3: B1_GSDF_RGBCE (BASELINE B1 + GEOGRAPHIC CONDITIONS AND SDF-WEIGHTED LOSS + RAINGATE BCE (WITHOUT REWEIGHTING)
# ===================================================================
# Baseline, different seed, paper 2
...
CFG="$CONFIG_DIR/baseline/V0__seed3.yaml"

echo "[INFO] Running V0__seed3: training → generation → quicklook → evaluation (inside container)"
