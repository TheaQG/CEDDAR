#!/bin/bash
#SBATCH --job-name=C_10__seed2
#SBATCH --output=logs/slurm_C_10__seed2_%x_%j.log
#SBATCH --error=logs/slurm_C_10__seed2_%x_%j.err
...
# ===================================================================
# C_10__seed2: V0 + CONTEXT ENCODER (LARGE DOMAIN, NOT PRE-CROPPED TO COLLOCATED REGION)
# ===================================================================
...
CFG="$CONFIG_DIR/context_only/C_10__seed2.yaml"

echo "[INFO] Running C_10__seed2: training → generation → quicklook → evaluation (inside container)"
