#!/bin/bash
#SBATCH --job-name=C_10_noSDF
#SBATCH --output=logs/slurm_C_10_noSDF_%x_%j.log
#SBATCH --error=logs/slurm_C_10_noSDF_%x_%j.err
...
# ===================================================================
# C_10_noSDF: V0 + CONTEXT ENCODER (LARGE DOMAIN, NOT PRE-CROPPED TO COLLOCATED REGION) no SDF-weighted loss
# ===================================================================
...
CFG="$CONFIG_DIR/context_only/C_10_noSDF.yaml"

echo "[INFO] Running C_10_noSDF: training → generation → quicklook → evaluation (inside container)"
