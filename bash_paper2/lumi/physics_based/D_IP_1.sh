#!/bin/bash
#SBATCH --job-name=D_IP_1
#SBATCH --output=logs/slurm_D_IP_1_%x_%j.log
#SBATCH --error=logs/slurm_D_IP_1_%x_%j.err
...
# ===================================================================
# D_IP_1: Physics-based set, precipitation + integrated water vapour flux (EWVF and NWVF)
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_IP_1.yaml"

echo "[INFO] Running D_IP_1: training → generation → quicklook → evaluation (inside container)"
