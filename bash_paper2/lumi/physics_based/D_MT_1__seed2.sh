#!/bin/bash
#SBATCH --job-name=D_MT_1__seed2
#SBATCH --output=logs/slurm_D_MT_1__seed2_%x_%j.log
#SBATCH --error=logs/slurm_D_MT_1__seed2_%x_%j.err
...
# ===================================================================
# D_MT_1__seed2: Simplest air-mass (msl + thetae_pl_850) without LR precipitation, large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MT_1__seed2.yaml"

echo "[INFO] Running D_MT_1__seed2: training → generation → quicklook → evaluation (inside container)"
