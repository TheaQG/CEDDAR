#!/bin/bash
#SBATCH --job-name=D_MTC_1
#SBATCH --output=logs/slurm_D_MTC_1_%x_%j.log
#SBATCH --error=logs/slurm_D_MTC_1_%x_%j.err
...
# ===================================================================
# D_MTC_1: Convective (msl + thetae_pl_850 + CAPE) without LR precipitation, large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MTC_1.yaml"

echo "[INFO] Running D_MTC_1: training → generation → quicklook → evaluation (inside container)"
