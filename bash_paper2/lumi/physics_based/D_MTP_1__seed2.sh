#!/bin/bash
#SBATCH --job-name=D_MTP_1__seed2
#SBATCH --output=logs/slurm_D_MTP_1__seed2_%x_%j.log
#SBATCH --error=logs/slurm_D_MTP_1__seed2_%x_%j.err
...
# ===================================================================
# D_MTP_1__seed2: Simple air mass (prcp + msl + thetae_pl_850), large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MTP_1__seed2.yaml"

echo "[INFO] Running D_MTP_1__seed2: training → generation → quicklook → evaluation (inside container)"
