#!/bin/bash
#SBATCH --job-name=D_MZP_1
#SBATCH --output=logs/slurm_D_MZP_1_%x_%j.log
#SBATCH --error=logs/slurm_D_MZP_1_%x_%j.err
...
# ===================================================================
# D_MZP_1: Simplest synoptic overview, no water vapour fluxes, (prcp + msl + z_pl_500), large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MZP_1.yaml"

echo "[INFO] Running D_MZP_1: training → generation → quicklook → evaluation (inside container)"
