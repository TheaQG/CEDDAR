#!/bin/bash
#SBATCH --job-name=D_MTP_1
#SBATCH --output=logs/slurm_D_MTP_1_%x_%j.log
#SBATCH --error=logs/slurm_D_MTP_1_%x_%j.err
...
# ===================================================================
# D_MTP_1: Simple air mass (prcp + msl + thetae_pl_850), large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MTP_1.yaml"

echo "[INFO] Running D_MTP_1: training → generation → quicklook → evaluation (inside container)"
