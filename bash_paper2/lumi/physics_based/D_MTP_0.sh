#!/bin/bash
#SBATCH --job-name=D_MTP_0
#SBATCH --output=logs/slurm_D_MTP_0_%x_%j.log
#SBATCH --error=logs/slurm_D_MTP_0_%x_%j.err
...
# ===================================================================
# D_MTP_0: Simple air mass (prcp + msl + thetae_pl_850), small domain, co-located with HR
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MTP_0.yaml"

echo "[INFO] Running D_MTP_0: training → generation → quicklook → evaluation (inside container)"
