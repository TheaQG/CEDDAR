#!/bin/bash
#SBATCH --job-name=D_MTCP_1
#SBATCH --output=logs/slurm_D_MTCP_1_%x_%j.log
#SBATCH --error=logs/slurm_D_MTCP_1_%x_%j.err
...
# ===================================================================
# D_MTCP_1: Convective WITH LR precipitation (prcp + msl + thetae_pl_850 + CAPE), large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MTCP_1.yaml"

echo "[INFO] Running D_MTCP_1: training → generation → quicklook → evaluation (inside container)"
