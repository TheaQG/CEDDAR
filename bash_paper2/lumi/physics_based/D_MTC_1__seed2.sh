#!/bin/bash
#SBATCH --job-name=D_MTC_1__seed2
#SBATCH --output=logs/slurm_D_MTC_1__seed2_%x_%j.log
#SBATCH --error=logs/slurm_D_MTC_1__seed2_%x_%j.err
...
# ===================================================================
# D_MTC_1__seed2: Convective (msl + thetae_pl_850 + CAPE) without LR precipitation, large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MTC_1__seed2.yaml"

echo "[INFO] Running D_MTC_1__seed2: training → generation → quicklook → evaluation (inside container)"
