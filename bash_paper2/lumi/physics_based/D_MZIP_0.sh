#!/bin/bash
#SBATCH --job-name=D_MZIP_0
#SBATCH --output=logs/slurm_D_MZIP_0_%x_%j.log
#SBATCH --error=logs/slurm_D_MZIP_0_%x_%j.err
...
# ===================================================================
# D_MZIP_0: Synoptic overview (prcp + msl + z_pl_500 + ewvf + nwvf), small domain, co-located with HR
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MZIP_0.yaml"

echo "[INFO] Running D_MZIP_0: training → generation → quicklook → evaluation (inside container)"
