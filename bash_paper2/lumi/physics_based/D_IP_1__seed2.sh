#!/bin/bash
#SBATCH --job-name=D_IP_1__seed2
#SBATCH --output=logs/slurm_D_IP_1__seed2_%x_%j.log
#SBATCH --error=logs/slurm_D_IP_1__seed2_%x_%j.err
...
# ===================================================================
# D_IP_1__seed2: Physics-based set, precipitation + integrated water vapour flux (EWVF and NWVF)
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_IP_1__seed2.yaml"

echo "[INFO] Running D_IP_1__seed2: training → generation → quicklook → evaluation (inside container)"
