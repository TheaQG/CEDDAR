#!/bin/bash
#SBATCH --job-name=D_MZIP_1__seed2
#SBATCH --output=logs/slurm_D_MZIP_1__seed2_%x_%j.log
#SBATCH --error=logs/slurm_D_MZIP_1__seed2_%x_%j.err
...
# ===================================================================
# D_MZIP_1__seed2: Synoptic overview (prcp + msl + z_pl_500 + ewvf + nwvf), large domain context
# ===================================================================
...
CFG="$CONFIG_DIR/physics_based/D_MZIP_1__seed2.yaml"

echo "[INFO] Running D_MZIP_1__seed2: training → generation → quicklook → evaluation (inside container)"
