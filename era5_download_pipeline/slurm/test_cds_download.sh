...
ACCOUNT="project_<your_project_id>"
...
MMB=/pfs/lustrep2/scratch/project_<your_project_id>/micromamba/bin/micromamba
export MAMBA_ROOT_PREFIX=/pfs/lustrep2/scratch/project_<your_project_id>/micromamba
