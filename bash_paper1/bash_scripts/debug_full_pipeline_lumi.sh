#!/bin/bash
#SBATCH --job-name=full_EDM
#SBATCH --output=logs/full_EDM_%j.log
#SBATCH --error=logs/full_EDM_%j.err
...
srun singularity exec $CONTAINER \
    python -m sbgm.cli.main_app --mode full_pipeline --config $CONFIG_DIR/full_run_debug.yaml