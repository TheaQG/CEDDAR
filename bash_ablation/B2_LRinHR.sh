#!/bin/bash
#SBATCH --job-name=B2_LRinHR
#SBATCH --output=logs/slurm_B2_LRinHR_%x_%j.log
#SBATCH --error=logs/slurm_B2_LRinHR_%x_%j.err
...
# ===================================================================
# B2_LRinHR: BASELINE B2 + LR CONDITION SCALED WITH HR STATISTICS
# ===================================================================
...
CFG="$CONFIG_DIR/B2_LRinHR.yaml"

echo "[INFO] Running ablation B2 + LR condition scaled with HR statistics: training → generation → quicklook → evaluation (inside container)"
