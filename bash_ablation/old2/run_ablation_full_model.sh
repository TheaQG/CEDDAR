...
#SBATCH --output=logs/slurm_full_model_%x_%j.log
#SBATCH --error=logs/slurm_full_model_%x_%j.err
...
CONFIG_DIR="$ROOT_DIR/sbgm/config" # /ablation
...
CFG="$CONFIG_DIR/paper1_final_config.yaml"
