#!/bin/bash
#SBATCH --job-name=B2_D
#SBATCH --output=logs/slurm_B2_D_%x_%j.log
#SBATCH --error=logs/slurm_B2_D_%x_%j.err
...
# ===================================================================
# B2_D: BASELINE B2 + DUAL LR CHANNELS
# ===================================================================
...
CFG="$CONFIG_DIR/B2_D.yaml"

echo "[INFO] Running ablation B2 + dual LR channels: training → generation → quicklook → evaluation (inside container)"
