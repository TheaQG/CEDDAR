...
#SBATCH --output=logs/slurm_run_temp_%x_%j.log
#SBATCH --error=logs/slurm_run_temp_%x_%j.err
...
srun singularity exec "$CONTAINER" bash -lc "
  ...
  python -m sbgm.cli.main_app --mode full_pipeline --config_path $CONFIG_DIR/temperature_basic.yaml --make_plots
"
