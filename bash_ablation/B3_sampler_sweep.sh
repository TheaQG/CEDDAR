#!/bin/bash
#SBATCH --job-name=B3_sampler_sweep
#SBATCH --output=logs/slurm_B3_sampler_sweep_%A_%a.out
#SBATCH --error=logs/slurm_B3_sampler_sweep_%A_%a.err
...
#SBATCH --array=0-59%15               # 60 combos → indices 0..59, max 15 concurrent tasks
...
CFG="$CONFIG_DIR/B3_sampler_sweep.yaml"
